...
class _AssignScreenState extends State<AssignScreen> {
        ...
        child: Row(
          children: [
            Checkbox(
              ...
              visualDensity: VisualDensity.compact,
              onChanged: (v) =>
                  setState(() => v! ? selected.add(a.id) : selected.remove(a.id)),
            ),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _right(List<Attendee> chosen) {
    ...
    final seats = picked.fold(0, (s, r) => s + store.freeSeats(r).clamp(0, 9999));
      ...
      child: Wrap(
        ...
        children: [
          ...
          _CountPill(
            ...
            onClear: picked.isEmpty ? null : () => setState(selectedRooms.clear),
          ),
          FilledButton.icon(
...
class _CountPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      ...
      border: Border.all(
        color: active ? AppColors.brand.withValues(alpha: 0.3) : AppColors.border,
      ),
    ),
    child: Row(
      mainAxisSize: MainAxisSize.min,
...
class _RoomPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: on ? AppColors.info.withValues(alpha: 0.12) : AppColors.surfaceAlt,
